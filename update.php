                ...
                <main style="margin: 20px 20px 0px 20px;">
                    <form id="mainform" method="POST" enctype="multipart/form-data">
					    ...
					    <div class="form-group col-md-6">
					      ...
					      <input type="text" class="form-control" id="inputEmail4" placeholder="tiêu đề" name="title" value="<?= $post['title']?>">
					    </div>
					    <div class="form-group col-md-6">
					      <label for="des">mô tả bài viết</label>
					      <textarea form="mainform" name="description" class="form-control" id="des"><?= $post['description']?></textarea>
					    </div>
					  </div>
					  <div class="form-row">
					    ...
					    <div class="form-group col-md-2">
                          ...
                          <img style="width: 150px;height: auto;" src="<?= $post['image']?>">
					    </div>
					  </div>
					...
					<textarea id="editor" form="mainform" name="content"><?= $post['content']?></textarea>
					 <button type="submit" class="btn btn-primary" form="mainform" name="submit">cập nhật bài viết</button>
                </main>
    ...
    <?php 
    	if(isset($_POST['submit'])){
            ...
            if($_FILES['anh']['size'] > 0){
                ...
                updatePost($title, $content, $category_id, $image, $description, $_GET['id']);
            }
            else{
                updatePost($title, $content, $category_id, "n", $description, $_GET['id']);
            }
    	}
    ?>
</html>
